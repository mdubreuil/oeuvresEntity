...
@NamedQueries({
    ...
    @NamedQuery(name = "Reservation.findByCouple", query = "SELECT r FROM Reservation r WHERE r.reservationPK.dateReservation = :dateReservation AND r.reservationPK.idOeuvre = :idOeuvre")})
